...
Internal GPU power is read through NVML on NVIDIA devices and ROCm-SMI on AMD.
...
Per-sample logs are aggregated to per-configuration means across the four repetitions. All linear fits in \S\ref{results} are ordinary least squares of internal GPU power on the empirical (CalFLOPS-based) MFU.
...
\begin{figure}[h]
    ...
    \caption{Internal GPU-reported vs. external hardware-based power measurements for NVIDIA L40 and Quadro RTX 5000.}
