...
This work evaluates whether Model FLOPs Utilization (MFU), an analytical metric relating achieved throughput to peak hardware capability, can serve as a portable, software-defined predictor of GPU power for training large language models.
